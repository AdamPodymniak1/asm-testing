...
#define SIZE 2400			//rozmiar glownych macierzy
...
printf("ver. naive      = %lf s\n",time_tabl[1]);
printf("GFLOPS      = %lf\n\n",(double)f/time_tabl[1]*1.0e-9);

//-------------------------------------------------------------------------------

init_time();
dgemm_unroll_2x2(SIZE,a,b,d);
read_time(time_tabl);

printf("ver. unroll 2x2      = %lf s\n",time_tabl[1]);
printf("GFLOPS      = %lf\n\n",(double)f/time_tabl[1]*1.0e-9);

//-------------------------------------------------------------------------------

init_time();
dgemm_unroll_4x4(SIZE,a,b,d);
read_time(time_tabl);

printf("ver. unroll 4x4      = %lf s\n",time_tabl[1]);
printf("GFLOPS      = %lf\n\n",(double)f/time_tabl[1]*1.0e-9);

//-------------------------------------------------------------------------------

init_time();
dgemm_unroll_16x1(SIZE,a,b,d);
read_time(time_tabl);

printf("ver. unroll 16x1      = %lf s\n",time_tabl[1]);
printf("GFLOPS      = %lf\n\n",(double)f/time_tabl[1]*1.0e-9);

//-------------------------------------------------------------------------------

init_time();
dgemm_sse_2x2(SIZE,a,b,d);
read_time(time_tabl);

printf("ver. sse 2x2      = %lf s\n",time_tabl[1]);
printf("GFLOPS      = %lf\n\n",(double)f/time_tabl[1]*1.0e-9);

//-------------------------------------------------------------------------------

init_time();
dgemm_sse_4x4(SIZE,a,b,d);
read_time(time_tabl);

printf("ver. sse 4x4      = %lf s\n",time_tabl[1]);
printf("GFLOPS      = %lf\n\n",(double)f/time_tabl[1]*1.0e-9);
...
printf("ver. sse 16x1      = %lf s\n",time_tabl[1]);
printf("GFLOPS      = %lf\n\n",(double)f/time_tabl[1]*1.0e-9);

//-------------------------------------------------------------------------------

init_time();
dgemm_avx_4x4(SIZE,a,b,d);
read_time(time_tabl);

printf("ver. avx 4x4      = %lf s\n",time_tabl[1]);
printf("GFLOPS      = %lf\n\n",(double)f/time_tabl[1]*1.0e-9);

//-------------------------------------------------------------------------------

init_time();
dgemm_avx_8x8(SIZE,a,b,d);
read_time(time_tabl);

printf("ver. avx 8x8      = %lf s\n",time_tabl[1]);
printf("GFLOPS      = %lf\n\n",(double)f/time_tabl[1]*1.0e-9);

//-------------------------------------------------------------------------------

init_time();
dgemm_avx_16x1(SIZE,a,b,d);
read_time(time_tabl);

printf("ver. avx 16x1      = %lf s\n",time_tabl[1]);
printf("GFLOPS      = %lf\n\n",(double)f/time_tabl[1]*1.0e-9);
